...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_split_space(
   ...
   LT(_NAV,KC_A),  KC_S,  KC_D,  KC_F,   KC_G,   KC_H,  KC_J,   KC_K,  KC_L, KC_QUOT,
    ...
    KC_LCTL, DYN_REC_START1, DYN_REC_START2, MT(MOD_LCTL,KC_SPACE),  LT(_NUM_SYM,KC_SPACE),  DYN_MACRO_PLAY1, DYN_MACRO_PLAY2, KC_RALT,
  ...
  [_NUM_SYM] = LAYOUT_split_space(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC,
